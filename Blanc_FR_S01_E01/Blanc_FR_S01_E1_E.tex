...
%
%--------------------------------------------------------------------------
\superlarge My mega title


\noindent {\Large {\bf Questions conceptuelles }}\\[-4mm]
\begin{enumerate}
\item Les formes en général (les ronds, les triangles, les carrés et même les losanges) aussi numérotés de la figure ci-dessous représentent les positions de deux blocs à des intervalles de $0.20$s. Les blocs se déplacent vers la droite. Comparez l'accélération des deux blocs. 
